...
Invoke-DemoVMPrep 'cc_DC01' 'DC01' -FullServer2016
Invoke-DemoVMPrep 'cc_DC02' 'DC02' -FullServer2016
Invoke-DemoVMPrep 'cc_DC03' 'DC03' -FullServer2019
...
1..2 | ForEach-Object -Process {
  Invoke-DemoVMPrep "cc_S2D2016-$_" "S2D2016-$_" -FullServer2016
}
...
#region - 10a Building 2019 Member Servers to be used as DC's.
...
#region - 011 Building DHCP01 and 02...
...
Wait-PSDirect 'cc_S2D2016-2' -cred $localCred

$VMName = 'cc_S2D2016-1'
$GuestOSName = 'S2D2016-1'

1..2 | ForEach-Object -Process {
  Invoke-NodeStorageBuild "cc_S2D2016-$_" "S2D2016-$_"
}

Wait-PSDirect 'cc_S2D2016-2' -cred $domainCred

Invoke-Command -VMName 'cc_S2D2016-1' -Credential $domainCred {
  param ($domainName)
  do 
  {
    New-Cluster -Name S2DCluster -Node S2D2016-1, S2D2016-2 -NoStorage
  }
  until ($?)
